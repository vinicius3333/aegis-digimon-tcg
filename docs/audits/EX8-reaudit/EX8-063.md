...
```text
pnpm --filter @aegis/api exec oxlint src/cards/EX8/EX8-063.ts src/cards/EX8/EX8-063.test.ts
exit 0

pnpm --filter @aegis/api exec oxfmt --check src/cards/EX8/EX8-063.ts src/cards/EX8/EX8-063.test.ts
