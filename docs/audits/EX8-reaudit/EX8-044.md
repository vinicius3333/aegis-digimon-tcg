...
```text
pnpm --filter @aegis/api exec oxlint src/cards/EX8/EX8-044.ts src/cards/EX8/EX8-044.test.ts
exit 0

pnpm --filter @aegis/api exec oxfmt --check src/cards/EX8/EX8-044.ts src/cards/EX8/EX8-044.test.ts
