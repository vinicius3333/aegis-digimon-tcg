...
### Current recalculation by card

Catalog/rules, IR trace, behavioral proof and comparative/stack proof were re-inspected in the current three Luna lanes. Each dimension scores 0–2; the last dimension is delivery, awarded after closing gates, the implementation commit and branch push. The detailed printed contracts, clause maps and KB ambiguities in the historical sections below remain the source inventory, except EX3-012's main/inherited classification superseded above. The table identifies current comparative and negative proof titles in the colocated test files; final suite counts are recorded separately under closing gates.

| Card    | Current rubric (catalog / IR / behavior / stack / delivery) | Representative existing public proof                                                                                                                                                                                              |
| ------- | ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
All 74 cards are currently certified 10/10 by the 2026-09-13 recalculation and closing gates. EX3-012 and EX3-035 reopenings are closed. The following historical and KB items remain worth knowing.
