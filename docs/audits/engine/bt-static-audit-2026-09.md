---
title: BT1-BT26 static card implementation reconciliation
updated: 2026-09-05
---

> Historical cross-set summary from 2026-08-29. Superseded by the per-set documents at
> `docs/audits/<SET>.md`, which are the current ledger. Kept for the aggregate counts and the
> catalog blob hash it records.
