...
| Execute            | §16-38 (`comprehensive-0257`, SHA-256 `5c658ed9c22510cf864a100b7cd55942c1109a0ceb63e0d432650f8214d68fcb`), `BT20-072.test.ts`: public end-turn attack, printed self-deletion, inherited and printed replay, alternate-target acceptance, and explicit On Deletion refusal | Core printed attack/replay/refusal path is bounded by a real six-test consumer suite; additional provider/source-duration classes remain inventory work |
...
| DeDigivolve        | §16-12 (`comprehensive-0230`, SHA-256 `7a6651cefa85e454cb7e4e43b0fe25217d28676ed7ef13c1dca57b1c8c4365bd`), conformance parameters plus public `cards/BT23/BT23-096.test.ts` N=4 declaration/floor (three effective peels with the Lv.3 floor) and `cards/EX7/EX7-049.test.ts` public N=4 consumer | N=1–4 declarations and choose-one-of-N are behaviorally anchored; the two four-value cases exercise different semantics (BT23 floor truncation versus EX7 four-source removal), and multi-target declarations are not a distinct current provider class |
| Recovery           | §16-6 `comprehensive-0224` (SHA-256 `5639a0a98e8ef565e6fb4895f6e03d2beef6ce819056dae2015103762b7f655d`); `keyword-recovery-parameters.test.ts`                                                                                                                                                      | Public +1/+2 exact face-down security order, five/six-security boundary, empty deck, and exact deck order are passed; grant/inherited amount classes remain open                                           |
...
| Engage             | §16-44 (`comprehensive-0321`), `cards/BT26/BT26-016.test.ts`, and `engine/conformance/keyword-engage-consent.test.ts`                                                                                                                                                                               | Public acceptance and explicit manual refusal/decline are covered; other printed provider shapes remain inventory work                                                                                     |
