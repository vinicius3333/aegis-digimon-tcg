...
| Execute            | §16-38 (`comprehensive-0257`), `BT20-072.test.ts`: public end-turn attack, printed self-deletion, alternate-target acceptance, and explicit On Deletion refusal                                                                                                                                     | Core printed attack/replay/refusal path is bounded; additional provider/source-duration classes remain inventory work                                                                                      |
...
| DeDigivolve        | §16-12 (`comprehensive-0230`, SHA-256 `7a6651cefa85e454cb7e4e43b0fe25217d28676ed7ef13c1dca57b1c8c4365bd`), conformance parameters plus public `cards/BT23/BT23-096.test.ts` N=4 floor/IDs and `cards/EX7/EX7-049.test.ts` attack consumer                                                           | N=1–4 and choose-one-of-N are behaviorally anchored; multi-target declarations are not a distinct current provider class                                                                                   |
| Recovery           | §16-6 `comprehensive-0224` (SHA-256 `5639a0a98e8ef565e6fb4895f6e03d2beef6ce819056dae2015103762b7f655d`); `keyword-recovery-parameters.test.ts`                                                                                                                                                      | Public +1/+2 exact face-down security order, five/six-security boundary, empty deck, and exact deck order are passed; grant/inherited amount classes remain open                                           |
