...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Blocker            | §16-5, `keyword-blocker-source-changes.test.ts`, `combatRestrictCluster.test.ts`; native and source-change consumers                                                                                                                                                                                | No core gap found; duplicate Blocker instances and all grant shapes remain inventory reconciliation                                                                                              |
| Piercing           | §16-7, `keyword-piercing-lifecycle.test.ts`; native BT1-026, no-keyword control, loss/tie, and BT20-019 grant                                                                                                                                                                                       | No core gap found; inherited/grant expiry classes need explicit provider trace                                                                                                                   |
| Rush               | §16-15, `rush-lifecycle.md` and `ch16b-digivolve-and-battle-keywords.test.ts`; native, inherited, and same-turn attack                                                                                                                                                                              | No core gap found; remaining class is source-condition expiry across existing grant providers                                                                                                    |
| Raid               | §16-23, `keyword-raid-consent.test.ts`; public redirect acceptance/refusal and highest-DP target                                                                                                                                                                                                    | Source-change and additional target-selection classes remain unreviewed; Raid has no same-turn-play relaxation (that is Vortex)                                                                  |
| Reboot             | §16-11, `keyword-reboot-lifecycle.test.ts`; BT4-070, BT5-069, inherited BT19-020 public turn loop                                                                                                                                                                                                   | No core gap found; remaining class is runtime grant expiry rather than native unsuspend                                                                                                          |
| Jamming            | §16-9, `keyword-jamming-lifecycle.test.ts`; native, inherited, stronger-security loss, and ST1-16 effect exception                                                                                                                                                                                  | No core gap found; owner ledger has 4 tests; remaining forms are grant/source reconciliation                                                                                                     |
| Retaliation        | §16-13, `keyword-retaliation-lifecycle.test.ts`; native, inherited, plain control, and public Gaia Force cause exception                                                                                                                                                                            | No core gap found; tie/security/grant producer classes remain bounded inventory work                                                                                                             |
| Barrier            | §16-25, `keywordBattle.test.ts` and card providers; public battle prevention/security payment                                                                                                                                                                                                       | Exact payment/refusal source identity remains to be reconciled                                                                                                                                   |
| Evade              | §16-22, `BT19-018.test.ts` and `BT24-050.test.ts`; public effect accept/refuse, near miss, inherited, and Option path                                                                                                                                                                               | No core gap found; broader provider conditions remain unclassified                                                                                                                               |
| Save               | §16-20, BT19/BT21 provider tests; public bottom placement, refusal, source filtering, multiple-Tamer cases                                                                                                                                                                                          | No core gap found; remaining class is cross-zone/controller source ownership                                                                                                                     |
| Delay              | §16-17, `keyword-delay-boundaries.test.ts`; public delayed activation, expiry and refusal paths                                                                                                                                                                                                     | Additional source-zone/provider forms remain unreviewed                                                                                                                                          |
| Alliance           | §16-24, `keyword-alliance-consent.test.ts`; AD1-009 exact two-ally choice/refusal plus BT19-014/ST20-04/ST20-06/BT26-033 providers                                                                                                                                                                  | Duplicate instances, supporter changes/removal, ordering and nested battles remain unreviewed                                                                                                    |
| Fortitude          | §16-27, `fortitudeOrdering.test.ts`, BT20/BT24 provider tests; native replay, simultaneous ordering, and no-source negative                                                                                                                                                                         | No core gap found; remaining class is granted-source departure ordering                                                                                                                          |
| Blitz              | §16-16, chapter/card tests; public attack timing                                                                                                                                                                                                                                                    | Inherited and refusal timing classes remain bounded                                                                                                                                              |
| Collision          | §16-30, `keywordBattle.test.ts`; forced block and no-DP-bonus control                                                                                                                                                                                                                               | Grant duration/source changes remain unclassified                                                                                                                                                |
| Vortex             | §16-33, `vortex-timing.md`; printed ST18-08/ST18-12 activation/refusal, ST9-12 granted public attack, grant loss, and Shoto end-turn ordering                                                                                                                                                       | No core gap found in the reviewed timing/consumer paths; broader provider reconciliation remains unreviewed                                                                                      |
| Decoy              | §16-18 (`comprehensive-0236`), decoy provider tests: five-color eligibility, trait negative, refusal, and exact holder/source outcomes                                                                                                                                                              | Core printed/color/refusal path proved; grant/inherited duration classes unreviewed                                                                                                              |
...
| Execute            | §16-38 (`comprehensive-0257`), `BT20-072.test.ts`: public end-turn attack and printed self-deletion                                                                                                                                                                                                 | Refusal and alternate target remain unreviewed                                                                                                                                                   |
| Progress           | §16-39 (`comprehensive-0258`), `BT21-025.test.ts`: public attack immunity and outside-attack Gaia deletion                                                                                                                                                                                          | Only native attacking-holder form reviewed; grant/inherited forms unreviewed                                                                                                                     |
| IceClad            | §16-35 (`comprehensive-0254`), `keyword-iceclad-security-boundary.test.ts` plus combat tests: BT22-077 count/DP/tie and EX7-021 vs BT1-084 Security                                                                                                                                                 | Core ordinary/Security comparison proved; grant/source classes unreviewed                                                                                                                        |
| Training           | §16-41 (`comprehensive-0260`, SHA-256 `b7603283456371a6ab6f29c64ef1a78e2afe6094bf01b1706c0f3fa73f927cf7`), `engine/conformance/keyword-training-boundaries.test.ts` and EX9-008 public activation assert exact face-down instance placement, suspend cost, and natural controller main-phase timing | Empty-deck boundary is proved as unavailable activation; copied/granted source forms and repeat/once-per-turn/provider inventory remain unreviewed                                               |
| Armor Purge        | §16-19 (`comprehensive-0237`), existing combat/provider tests exercise promotion and deletion prevention                                                                                                                                                                                            | Chained replacement ordering remains unreviewed                                                                                                                                                  |
| Mind Link          | §16-28 (`comprehensive-0247`), chapter/card BT14-086 public activation moves exact Tamer source to Tamer-less target                                                                                                                                                                                | Choice/refusal variants unreviewed                                                                                                                                                               |
| Ascension          | §16-43 (`comprehensive-0262`), `keyword-ascension-lifecycle.test.ts`: printed/runtime grant, exact trash-to-security, expiry                                                                                                                                                                        | Additional grant source classes unreviewed                                                                                                                                                       |
| BlastDigivolve     | §16-26 (`comprehensive-0245`), card/chapter tests prove public counter digivolution and cost route                                                                                                                                                                                                  | Refusal/source-choice classes unreviewed                                                                                                                                                         |
| BlastDNADigivolve  | §16-31 (`comprehensive-0250`), card/chapter tests prove public counter DNA material routes                                                                                                                                                                                                          | Refusal and exact source identity classes unreviewed                                                                                                                                             |
| Draw               | §16-8 (`comprehensive-0226`), provider tests prove public draw amounts at current literal values                                                                                                                                                                                                    | Amount/timing classes beyond reviewed providers unreviewed                                                                                                                                       |
| SecurityAttack     | §16-3 (`comprehensive-0221`), security lifecycle tests prove public +1/-1 and natural expiry                                                                                                                                                                                                        | Other signed amounts and grant producers unreviewed                                                                                                                                              |
| DeDigivolve        | §16-12 (`comprehensive-0230`, SHA-256 `7a6651cefa85e454cb7e4e43b0fe25217d28676ed7ef13c1dca57b1c8c4365bd`), `engine/conformance/keyword-de-digivolve-parameters.test.ts`: public BT19-063 N=1, BT19-026 N=2, P-240 N=3, level-3/empty boundary, and public N=2 choice                                | N=1–3 and choose-one-of-N are exercised; N=4 and multi-target declarations remain unreviewed                                                                                                     |
| Recovery           | §16-6 (`comprehensive-0224`), recovery parameters test proves +1/+2 exact face-down security order and 6-security limit                                                                                                                                                                             | Grant/inherited amount classes unreviewed                                                                                                                                                        |
| DigiBurst          | §16-14 (`comprehensive-0232`), Digi-Burst owner tests prove amounts 1–4 and insufficient-material all-or-nothing behavior                                                                                                                                                                           | Distinct source-shape classes unreviewed                                                                                                                                                         |
| Digisorption       | §16-10 (`comprehensive-0228`), `engine/conformance/keyword-digisorption-consent.test.ts`: BT3-056 -3 accept/refusal with exact payer selection and BT5-058 -2 public evolution; chapter anchor remains `ch16b-digivolve-and-battle-keywords.test.ts` case `16-10-1`                                 | Printed -2/-3 acceptance, explicit refusal, and two-candidate physical payer identity are covered; other reductions, redirect/grant/inherited and once-per-turn source classes remain unreviewed |
| MaterialSave       | §16-21 (`comprehensive-0239/0240`), `engine/conformance/keyword-material-save-parameters.test.ts` cases “accepts Material Save 1/2/4”, printed 3, and explicit refusal; exact source instances and Tamer placement are asserted                                                                     | Amounts 1–4 are covered in this file; cross-stack controller/source-zone combinations and a distinct granted/inherited producer are not covered                                                  |
| DigiXrosSubstitute | §7-2 (`comprehensive-0117/0118`); `cards/BT19/BT19-079.test.ts` cases “under-Tamer material is legal” and “without suspending ... illegal”, plus `BT19-081.test.ts` matching public DigiXros expansion                                                                                              | These are DigiXros-expander tests, not a standalone public DigiXros Substitute consumer; substitute-specific printed/granted source-zone behavior remains unreviewed                             |
| Link               | §16-40 (`comprehensive-0259`), `engine/conformance/keyword-link-parameters.test.ts` cases “printed Link +6 capacity”, public cost 2, Appmon link, and unpaid-cost refusal                                                                                                                           | +1/+2/+6 are maximum-link-capacity parameters; the file proves +6 capacity and public link payment, while other capacity values/source-departure forms remain unreviewed                         |
| LinkMax            | §16-40 (`comprehensive-0259`), `engine/conformance/keyword-link-parameters.test.ts` case “uses printed Link Max +1 through a second public link intent”, with excess-link cleanup asserted in the same conformance family                                                                           | Printed Link Max +1 and excess cleanup are anchored; a granted Link Max expiry/source-change case is not exercised                                                                               |
| Fragment           | §16-37 (`comprehensive-0256`), `engine/conformance/keyword-fragment-parameters.test.ts` cases exact-three payment, insufficient-three no partial payment, refusal, and EX12-060 Fragment 2                                                                                                          | N=2 and N=3 public paths plus refusal/insufficiency are covered; other source-zone/provider forms are not exercised                                                                              |
| Partition          | §16-29 (`comprehensive-0248`), `engine/combat/executePartition.test.ts` cases opponent-effect replay, own-effect negative, non-Partition negative, and `cards/BT20/BT20-037.test.ts` public Option/refusal/DP-zero cases                                                                            | Opponent-effect versus own-effect cause and refusal are covered; additional source recipes/choice forms remain unreviewed                                                                        |
| Decode             | §16-36 (`comprehensive-0255`), `cards/BT19/BT19-024.test.ts` cases public Decode replay, refusal, battle-deletion negative, and own-stack Blue Lv.4 filtering                                                                                                                                       | The public replay/refusal and source-zone/level filter are exercised; a distinct replacement interaction remains unreviewed                                                                      |
| Overclock          | §16-34 (`comprehensive-0253`), `cards/BT19/BT19-101.test.ts` cases public On Play/When Attacking returns, refusal, no-target, and Q3185 end-turn attack while unsuspendable                                                                                                                         | Printed Overclock timing/refusal and no-target behavior are covered; another qualifier or granted-source producer is not                                                                         |
| UseReq             | §16-42 (`comprehensive-0261`, confirmed Use Req.), `engine/conformance/ch16c-deletion-and-advanced-keywords.test.ts` cases `BT25-093 compiles...`, unmet baseline, `[TS]` condition met, and all-24 compiler coverage                                                                               | The executable proof is the `[TS]` trait waiver and 24-card compile sweep; other named/trait waiver consumers still need runtime consumer traces                                                 |
| Engage             | §16-44 (`comprehensive-0321`), `cards/BT26/BT26-016.test.ts` case “uses Engage to make an optional end-of-turn player attack” and `cards/EX12/EX12-019.test.ts` cases “encodes Engage...”/live keywords                                                                                             | A public BT26-016 end-turn attack and EX12-019 encoding are anchored; explicit refusal/decline outcome for the end-turn attack remains unreviewed                                                |
| Guard              | §16-45 (`comprehensive-0322`), `engine/conformance/keyword-guard-lifecycle.test.ts` cases public Iron-Fisted Onslaught, public evolution grant, DP-rule deletion, battle deletion, Heat Viper payment, security-granted holder, and controller identity                                             | Native/granted holder identity, public causes, payment, and refusal/authority are exercised; chained replacement/source-race cases remain unreviewed                                             |
| Detach             | §16-46 (`comprehensive-0323`), `engine/conformance/keyword-detach-lifecycle.test.ts` cases controller-only decline, trait-mismatched link rejection, and owner-cost deletion negative                                                                                                               | Public decision authority, trait eligibility, and own-cost exception are executable; additional host-departure/payment-source forms remain unreviewed                                            |
| Succession         | §16-47 (`comprehensive-0324`), `engine/conformance/keyword-succession-lifecycle.test.ts` `it.each(consumers)` public evolution over four consumers plus public Chronomon attack acceptance/refusal                                                                                                  | Four top-card consumer identities and gained-effect acceptance/refusal are exercised; duration and later source-change behavior remain unreviewed                                                |
