...
| Digisorption | §16-10 (`comprehensive-0228`), `engine/conformance/ch16b-digivolve-and-battle-keywords.test.ts` case `16-10-1`; public BT3-056 suspend payment reduces the printed evolution cost | This anchor proves the one-card suspend payment path; refusal, multiple eligible payments, and granted/inherited Digisorption are not exercised by that case |
