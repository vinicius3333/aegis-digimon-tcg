...
| LinkMax            | §16-40 (`comprehensive-0259`), `engine/conformance/keyword-link-parameters.test.ts` case “uses printed Link Max +1 through a second public link intent”, with excess-link cleanup and BT26-086 +6 capacity in the same conformance family                                                                           | Printed Link Max +1 and the +6 capacity seam are anchored; no current granted Link Max producer was found |
