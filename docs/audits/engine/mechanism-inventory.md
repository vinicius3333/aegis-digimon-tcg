...
| Raid | §16-23, combat tests; public redirect and highest-DP target | Redirect refusal/source-change remains unreviewed; Raid has no same-turn-play relaxation (that is Vortex) |
...
| Delay | §16-17, existing card/chapter tests; public delayed activation and refusal paths | Concrete expiry/reset cases remain to be reconciled |
| Alliance | §16-24, battle consumer tests; public ally selection and DP addition | Multiple-ally ordering/refusal remains a parameter class |
