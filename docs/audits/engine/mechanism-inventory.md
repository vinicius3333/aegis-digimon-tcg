...
| Execute     | native consent/self-delete; permanent, `untilEachTurnEnd`, `forTheTurn`        | `BT23-069.test.ts`, `BT26-030.test.ts`, `BT26-078.test.ts`, `keyword-execute-consent.test.ts` | refusal, unsuspended target, complete self-delete, replay/refusal, and all current duration classes are covered |
