...
| Decoy              | §16-18 (`comprehensive-0236`, SHA-256 `311375329fc7791aba6a16b180691e3063bce3bba790f4f92dff802e21987ca1`); `keyword-decoy-source-continuity.test.ts` and `P-045.test.ts` cover public inherited P-045 grant, source-present control, source departure, and exact physical IDs | Native/public Decoy, persistent inherited source eligibility, source departure, and battle/effect boundaries are covered |
