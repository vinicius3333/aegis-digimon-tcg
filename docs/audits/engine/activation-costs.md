...
This proves these consumer boundaries, not all compound payment policy or BT15 collection fidelity. BT17-085, BT25-096, EX3-035 and ST17-10 exact-name consumers, general candidate overlap, ordered returns, targetless Option payment and cost-bearing evolution remain open.
