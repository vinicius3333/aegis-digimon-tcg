...
leaves 4 unchanged (**10/10** focused, 2 GB cap, one worker). The Security
self-play still has only a direct timing proof in this suite.
...
worker). The three/four-color attack sequence and Q7194 remain covered by
the earlier direct timing and mechanism tests.
