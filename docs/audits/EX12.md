...
The 2026-09-12 Guard consumer audit reopens the historical whole-collection
claim: security keyword visibility and actual Paishu prevention failed on the
prior implementation. The bounded correction now passes those paths, but
complete keyword exceptions and fresh whole-card/collection certification
remain open. EX12-056/057/072 remain capped below ten. See
[guard-lifecycle.md](engine/guard-lifecycle.md).
...
- Current score: capped at 8/10, provisional (2026-09-12). The canonical
  per-holder Guard correction and actual public consumer proof supersede the
  historical replacement claims below. This is a bounded mechanism slice;
  full source exceptions, legal initial lines and all printed card clauses
  are not freshly certified. See [guard-lifecycle.md](engine/guard-lifecycle.md).
...
- Current Guard audit: EX12-056/057/072 are provisionally capped below ten;
  current source/consumer exceptions and whole-card obligations remain open.
  The older "no open seam" closeout below is historical and is superseded by
  [guard-lifecycle.md](engine/guard-lifecycle.md).
