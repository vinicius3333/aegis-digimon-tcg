...
All 112 BT5 cards are verified at 10/10. The winning source is the 2026-09-10 re-audit
(`docs/audits/BT5-REAUDIT-LEDGER.md` and `docs/audits/BT5-reaudit/RUN.md`, commit `6dde01ed6`),
which rebuilt every row from zero against the cumulative BT4 base and awarded delivery gates only
after the exact BT5 collection, effects sync and check, affected mechanisms, full typecheck, lint,
format, and diff gates were green. Its per-card rows and its summary agree: gates 2/2, 10/10,
aggregate 1120/1120. The 2026-09-05 campaign closeout (`docs/audits/BT5-STATIC-AUDIT.md`) reached
the same 112/112 result and is kept below as the earlier gate record. Older documents that scored
cards at a provisional 8/10 with deferred gates — the range reports under `internal-docs/audits/BT5/`
and `docs/audits/BT5-AUDIT.md` — are superseded; their clause traces are merged into the card ledger
for the detail, not for the score.

## Gates

### Final re-audit run, 2026-09-10

Source: `docs/audits/BT5-reaudit/RUN.md` (commit 6dde01ed6).
...
Re-audit row (`docs/audits/BT5-REAUDIT-LEDGER.md`, 2026-09-10): catalog 2, IR 2, behavior 2, peer/stack 2, gates 2, score 10/10. Focused batch and independent static evidence green.
Static closeout (`docs/audits/BT5-STATIC-AUDIT.md`, 2026-09-05): Verified 10/10 in the BT5-001–010 range row.

Clause trace merged from `docs/audits/BT5-AUDIT.md`. Statements in it about provisional scores, deferred gates, or snapshot drift describe the pre-closeout worker pass and are superseded by the Gates section above.
...
Re-audit row (`docs/audits/BT5-REAUDIT-LEDGER.md`, 2026-09-10): catalog 2, IR 2, behavior 2, peer/stack 2, gates 2, score 10/10. Focused batch and independent static evidence green.
Static closeout (`docs/audits/BT5-STATIC-AUDIT.md`, 2026-09-05): Verified 10/10 in the BT5-011–020 range row.
...
Re-audit row (`docs/audits/BT5-REAUDIT-LEDGER.md`, 2026-09-10): catalog 2, IR 2, behavior 2, peer/stack 2, gates 2, score 10/10. Focused batch and independent static evidence green.
Static closeout (`docs/audits/BT5-STATIC-AUDIT.md`, 2026-09-05): Verified 10/10 in the BT5-021–030 range row.
...
Re-audit row (`docs/audits/BT5-REAUDIT-LEDGER.md`, 2026-09-10): catalog 2, IR 2, behavior 2, peer/stack 2, gates 2, score 10/10. Focused batch and independent static evidence green.
Static closeout (`docs/audits/BT5-STATIC-AUDIT.md`, 2026-09-05): Verified 10/10 in the BT5-031–040 range row.
...
Re-audit row (`docs/audits/BT5-REAUDIT-LEDGER.md`, 2026-09-10): catalog 2, IR 2, behavior 2, peer/stack 2, gates 2, score 10/10. Focused batch and independent static evidence green.
Static closeout (`docs/audits/BT5-STATIC-AUDIT.md`, 2026-09-05): Verified 10/10 in the BT5-041–050 range row.
...
Re-audit row (`docs/audits/BT5-REAUDIT-LEDGER.md`, 2026-09-10): catalog 2, IR 2, behavior 2, peer/stack 2, gates 2, score 10/10. Focused sweep and independent static evidence green.
Static closeout (`docs/audits/BT5-STATIC-AUDIT.md`, 2026-09-05): Verified 10/10 in the BT5-051–060 range row.
...
Re-audit row (`docs/audits/BT5-REAUDIT-LEDGER.md`, 2026-09-10): catalog 2, IR 2, behavior 2, peer/stack 2, gates 2, score 10/10. Focused sweep and independent static evidence green.
Static closeout (`docs/audits/BT5-STATIC-AUDIT.md`, 2026-09-05): Verified 10/10 in the BT5-061–070 range row.
...
Re-audit row (`docs/audits/BT5-REAUDIT-LEDGER.md`, 2026-09-10): catalog 2, IR 2, behavior 2, peer/stack 2, gates 2, score 10/10. Focused sweep and independent static evidence green.
Static closeout (`docs/audits/BT5-STATIC-AUDIT.md`, 2026-09-05): Verified 10/10 in the BT5-071–080 range row.
...
Re-audit row (`docs/audits/BT5-REAUDIT-LEDGER.md`, 2026-09-10): catalog 2, IR 2, behavior 2, peer/stack 2, gates 2, score 10/10. Focused sweep and independent static evidence green.
Static closeout (`docs/audits/BT5-STATIC-AUDIT.md`, 2026-09-05): Verified 10/10 in the BT5-091–100 range row.
...
Re-audit row (`docs/audits/BT5-REAUDIT-LEDGER.md`, 2026-09-10): catalog 2, IR 2, behavior 2, peer/stack 2, gates 2, score 10/10. Focused sweep and independent static evidence green.
Static closeout (`docs/audits/BT5-STATIC-AUDIT.md`, 2026-09-05): Verified 10/10 in the BT5-101–110 range row.
...
Re-audit row (`docs/audits/BT5-REAUDIT-LEDGER.md`, 2026-09-10): catalog 2, IR 2, behavior 2, peer/stack 2, gates 2, score 10/10. Focused sweep and independent static evidence green.
Static closeout (`docs/audits/BT5-STATIC-AUDIT.md`, 2026-09-05): Verified 10/10 in the BT5-111–112 range row.
...
No `*-MECHANISM.md` note was written for BT5. The engine seams this set exercises are listed in the affected-mechanism manifest under Gates.

## Knowledge base index

Source: `docs/audits/BT5-reaudit/KB-INDEX.md`.

Card-specific rulings are resolved from the committed knowledge base during each card review.

## Open items

- No card is below 10/10 and no unresolved ambiguity is recorded. `docs/audits/BT5-STATIC-AUDIT.md`
  reports blocked or ambiguous: 0, and the 2026-09-10 ledger accepts 112/112.
- Contradiction: the range reports in `internal-docs/audits/BT5/` (2026-08-27, commit `eb1a58b75`)
  score every card 8/10 provisional with executed gates 0/2 and record stale `effects.json` entries
  for cards such as BT5-004, BT5-008, and BT5-010. `docs/audits/BT5-STATIC-AUDIT.md` (2026-09-05) and
  the 2026-09-10 re-audit both report the snapshot synchronized with zero out-of-set changes and all
  gates executed. The newer reports win; the clause traces below keep the older wording.
- Contradiction: `docs/audits/BT5-STATIC-AUDIT.md` (2026-09-05) reports the API typecheck as clean
  except for pre-existing diagnostics in `engine/state/digivolutionStackSync.test.ts` and
  `engine/state/syncedArrayInsert.test.ts`, while the 2026-09-10 run reports the full workspace
  typecheck passing for shared, API, and web. The later, greener result is not re-verified here.
- `docs/audits/BT5-AUDIT.md` (2026-08-30) recorded `pnpm typecheck` as blocked by unrelated errors in
  `EX6-010.test.ts` and several interpreter files. Both later reports contradict it. No command was
  re-run for this consolidation.
...
- `docs/audits/BT5-REAUDIT-LEDGER.md` — `6dde01ed6`, 2026-09-10. Independent evidence ledger, 112
  rows at 10/10 with delivery gates. Merged into Card ledger.
- `docs/audits/BT5-reaudit/` (4 files: `RUN.md`, `KB-INDEX.md`, `REVIEW-NOTES.md`,
  `WORKER-BRIEF.md`) — `6dde01ed6`, 2026-09-10. Run log, knowledge base index, empty review queue,
  and the read-only worker brief. Run log merged into Gates; index merged into Knowledge base index.
- `docs/audits/BT5-STATIC-AUDIT.md` — `eb1a58b75`, 2026-09-05. Campaign closeout with the executed
  verification list and the 112-row score table. Merged into Gates and Card ledger.
- `internal-docs/audits/BT5/` (12 range reports, `BT5-001-010.md` through `BT5-111-112.md`) —
  `eb1a58b75`, 2026-09-05. Worker-stage clause traces, 8/10 provisional. Merged into Card ledger.
- `docs/audits/BT5-AUDIT.md` — `d9d57ae08`, 2026-08-30. Earlier 112-card ledger with per-card
  primitive traces and focused test counts. Merged into Card ledger.
- `docs/audits/BT5-AUDIT-LEDGER.md` — `d9d57ae08`, 2026-08-30. Method note and a card-to-test index
  that adds nothing beyond the module and test paths already implied by each card ID. Dropped.
- `docs/audits/collections-summary.md` — never committed (untracked), generated 2026-08-22. Cross-set status table, deleted in favour of the generated index in `docs/audits/README.md`. It was the only record of this delivery evidence for BT5: PR #4575; commit `d4cb36307`.
