 ...
 * (the default for conditions like `youHave` and `opponentHas`). The default
 * board pool includes both the battle area and the breeding area: both are
 * in-play zones for possession conditions such as ＜Use Req.＞.
 */
