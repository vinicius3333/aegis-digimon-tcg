...
const mainActions = [
  { kind: "PlaceUnder", target: { filter: { isSelfRef: true }, count: 1, isSelf: true }, fromDeckTop: true, faceDown: true, position: "bottom" },
  { kind: "GainMemory", amount: 1, condition: { kind: "opponentHas", filter: { controllerDefault: "opponent", kind: ["Digimon"] } } },
];
