...
export const compiled: CompiledCard = {
  effects: [
    ...
    { trigger: "StartOfYourTurn", actions: [{ kind: "WinGame", winner: "controller", condition: { kind: "permanentCount", seat: "mine", op: "gte", value: 4, filter: { nameOrTrait: [{ tokens: ["Doomsday Clock"], match: "nameExact" }] } } }] },
