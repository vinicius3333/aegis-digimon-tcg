...
export const compiled: CompiledCard = {
  effects: [
    ...
    { trigger: "YourTurn", actions: [{ kind: "SubTrigger", event: "whenEffectAddsToHand", actions: [{ kind: "SecurityManipulation", op: "toHand", controller: "opponent", amount: 1, toTop: true }] }], frequency: "OncePerTurn" },
