...
describe("EX1-015 Garurumon", () => {
  it("plays a Matt Ishida costing 3 or less for free on attack", async () => {
    const s = setupEngine({ 0: { battleArea: [{ card: "EX1-017", as: "attacker", under: ["EX1-015"] }], hand: [{ card: "ST2-12", as: "matt" }] }, 1: { security: ["BT1-001", "BT1-001"] } }, { autoAcceptOptional: true, autoSelectCards: true });
