...
describe("EX1-007 Megadramon", () => {
  it("deletes up to 2 opposing Digimon with 3000 DP or less on play", async () => {
    const s = setupEngine({ 0: { hand: [{ card: "EX1-007", as: "megadramon" }] }, 1: { battleArea: [{ card: "BT1-009", as: "small1", dp: 3000 }, { card: "BT1-010", as: "small2", dp: 2000 }, { card: "BT1-011", as: "large", dp: 4000 }] } }, { autoSelectCards: true });
    s.state.memory = 10;
