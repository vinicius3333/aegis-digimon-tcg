...
const freeSource = { kind: "selfDigivolutionStackHasTrait", filter: { nameOrTrait: [{ tokens: ["Free"], match: "trait" }] } };
  ...
  effects: [
    {
      ...
      actions: [
        ...
        { kind: "Suspend", target: { filter: { controller: "opponent", kind: ["Digimon"] }, count: 1 }, condition: freeSource },
      ],
    },
    {
      trigger: "YourTurn",
