...
describe("EX2-070 Digivolution Plug-In S", () => {
  it("draws 1 before its optional free digivolution", async () => {
    const s = setupEngine({ 0: { battleArea: ["EX2-025", "EX2-061"], hand: [{ card: "EX2-070", as: "option" }], deck: [{ card: "BT1-001", as: "drawn" }] } }, { autoDeclineOptional: true, autoOrderTriggers: true });
    s.state.memory = 10;
