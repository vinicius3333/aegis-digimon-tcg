...
describe("EX2-069 Fist of the Beast King", () => {
  it("unsuspends Leomon or Beelzemon", async () => {
    const s = setupEngine({ 0: { battleArea: [{ card: "EX2-044", as: "beelzemon", suspended: true }, "EX2-014"], hand: [{ card: "EX2-069", as: "option" }] } }, { autoSelectCards: true, autoOrderTriggers: true });
    s.state.memory = 10;
