...
describe("EX2-018 MarineAngemon", () => {
  it("recovers for opposing source-free Digimon without raising security above 5", async () => {
    const s = setupEngine({ 0: { hand: [{ card: "EX2-018", as: "marine" }], deck: ["BT1-001", "BT1-002"], security: ["BT1-003", "BT1-004", "BT1-005", "BT1-006"] }, 1: { battleArea: ["EX2-014", "EX2-019"] } }, { autoOrderTriggers: true });
    s.state.memory = 10;
