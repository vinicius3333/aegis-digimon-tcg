...
const compiled: CompiledCard = {
  effects: [
    ...
    { trigger: "Main", actions: [{ kind: "Modal", choose: 1, condition: { kind: "allOf", conditions: [{ kind: "youHaveGreenLevelAtLeastInBattle", value: 5 }, { kind: "breedingActionAvailable" }] }, options: [
      [{ kind: "Hatch" }],
