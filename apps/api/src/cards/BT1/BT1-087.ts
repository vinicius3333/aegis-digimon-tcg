...
const compiled: CompiledCard = {
  effects: [
    ...
    { trigger: "OnPlay", actions: [
      { kind: "SecurityManipulation", op: "toHand", controller: "mine", source: "securityTop", chooseFromSecurity: true, selectionFilter: { controller: "mine" }, amount: 1, bindResultAs: "bt1-087-selected" },
      { kind: "Recover", amount: 1, condition: { kind: "bindingContains", ref: "bt1-087-selected", filter: { colors: ["Yellow"] } } },
