...
const mode = { kind: "ConditionalBranch", condition: { kind: "opponentHas", countMin: 2, filter: { kind: ["Digimon"], dp: { op: "lte", value: 5000 } } }, ifTrue: [modal], ifFalse: [one] };
export const compiled: CompiledCard = { effects: [{ trigger: "Main", actions: [mode] }, { trigger: "Security", actions: [mode] }], coverage: "full", residual: [] };
