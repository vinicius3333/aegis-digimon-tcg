  ...
  effectsForTiming(timing: EffectTiming, source: CardSource): Effect[] {
    ...
    return [
      whenDigivolving({
        ...
        description: "[When Digivolving] 1 opposing Digimon gets -8000 DP for the turn.",
        resolve: async (ctx) => {
          ...
          if (chosen[0]) ctx.fx.modifyDP(chosen[0], -8000, EffectDuration.UntilEachTurnEnd);
        },
      }),
    ];
  },
