      ...
      actions: [
        {
          ...
          add: [
            ...
            { filter: { hasInheritedEffects: true, controllerDefault: "mine", kind: ["Tamer"], colors: ["Red"] }, count: 1, to: "hand" },
          ],
          rest: "deckBottom",
        },
      ],
      ...
      actions: [
        {
          ...
          sourceFilter: { controllerDefault: "mine", kind: ["Digimon", "Tamer"], nameOrTrait: [{ tokens: ["Hybrid", "Ten Warriors"], match: "trait" }] },
