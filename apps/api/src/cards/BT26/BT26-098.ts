  ...
  effects: [
    ...
    },
    {
      ...
      actions: [
        {
          kind: "PlaceUnder",
          target: { filter: sunflowmon, count: 1 },
          destination: { filter: lalamon, count: 1 },
          bindHostAs: "lalamonHost",
          position: "bottom",
        },
        {
          kind: "PlaceUnder",
          target: { filter: lilamon, count: 1 },
          underSelectionRef: "lalamonHost",
          position: "bottom",
        },
        {
          kind: "Digivolve",
          target: { filter: lalamon, count: 1 },
