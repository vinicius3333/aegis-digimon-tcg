...
export const compiled: CompiledCard = { effects: [
  ...
  { trigger: "YourTurn", actions: [{ kind: "Replacement", event: "wouldBePlayed", sourceFilter: { controllerDefault: "mine", kind: ["Digimon"], nameOrTrait: [{ tokens: ["Boss", "TS"], match: "trait" }] }, actions: [{ kind: "Replacement", event: "wouldBePlayed", mode: "reduceCost", amountChoices: [
