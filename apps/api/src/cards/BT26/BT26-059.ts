...
const shared = [
  { kind: "Trash", target: { filter: { controller: "mine", zone: "hand" }, count: 1 }, optional: true, condition: { kind: "isYourTurn", raw: "if it is your turn" } },
  { kind: "PlayWithoutCost", target: titan, from: ["trash"], payCost: true, reduceCostBy: 7, optional: true, condition: { kind: "isYourTurn", raw: "if it is your turn" } },
];
