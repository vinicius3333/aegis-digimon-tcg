...
const costDigimon = { controllerDefault: "mine", kind: ["Digimon"], nameOrTrait: [
...
const weaken = [{ kind: "GainKeyword", target: { filter: opponentDigimon, count: 1 }, keyword: { keyword: "SecurityAttack", amount: -2 }, duration: "untilOpponentTurnEnd", optional: true, cost: { kind: "suspend", target: { filter: costDigimon, count: 1 } } }];
