      ...
      effects: [
        {
          trigger: "Static",
          actions: [
            { kind: "WaiveColorRequirement", condition: { kind: "youHave", filter: { traits: ["Armor Form"] } } },
          ],
        },
        {
          trigger: "Main",
          actions: [
            {
              ...
              optional: true,
              target: { filter: { traits: ["Armor Form"] } },
              into: { nameOrTrait: [{ tokens: ["Magnamon"], match: "name" }] },
            },
            {
              kind: "Restrict",
          ...
          actions: [
            {
              kind: "Return",
              to: "hand",
              target: { filter: { nameOrTrait: [{ tokens: ["Magnamon"], match: "name" }] } },
            },
            { kind: "AddToHandSelf" },
          ],
        },
