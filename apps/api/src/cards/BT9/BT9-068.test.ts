  ...
  it("matches catalog and Q1856/Q1857 rule-name, dual-color IR", () => {
    ...
    expect(compiled).toMatchObject({
      ...
      effects: [
        {
          trigger: "Static",
          actions: [{ kind: "GrantStatic", grant: "name", tokens: ["Greymon"] }],
          keywords: [{ keyword: "SecurityAttack", amount: 1 }, { keyword: "Reboot" }],
        },
        {
          trigger: "WhenDigivolving",
          actions: [
            { kind: "DeDigivolve", amount: 1, condition: { kind: "selfDigivolutionStackHasColor" } },
            {
              kind: "GainKeyword",
              keyword: { keyword: "Blitz" },
              duration: "forTheTurn",
              condition: { kind: "selfDigivolutionStackHasColor" },
            },
          ],
        },
      ],
