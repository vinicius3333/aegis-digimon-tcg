...
describe("BT14-020", () => {
  it("trashes one opposing source and prevents this Digimon from being blocked at the start of your main phase", () =>
  ...
  it("inherits replacement play of Gomamon from its digivolution cards when deleted", () =>
      ...
      actions: [
        {
          ...
          actions: [{ kind: "PlayWithoutCost", from: ["digivolutionCards"], payCost: false }],
        },
      ],
    }));
