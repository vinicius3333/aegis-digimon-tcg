...
const source = { instanceId: "source", cardId: "BT15-033", ownerSeat: 0, definition: {}, permanent: () => ({ permanentId: "perm" }), isOnBattleArea: () => true, isOwnersTurn: () => true, hasColor: () => true } as never;
