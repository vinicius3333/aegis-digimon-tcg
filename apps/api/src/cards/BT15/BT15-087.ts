...
const traitFilter: Filter = { nameOrTrait: [{ tokens: ["X Antibody", "DigiPolice"], match: "trait" }] };
...
export const compiled: CompiledCard = {
  effects: [
    ...
    },
    {
      trigger: "Main",
      actions: [
        { kind: "MindLink", target: { filter: { controller: "mine", kind: ["Digimon"], ...traitFilter }, count: 1 } },
      ],
    },
    {
      trigger: "AllTurns",
      ...
      actions: [
        {
          ...
          while: { kind: "selfTopHasText", filter: traitFilter },
        },
        {
          kind: "Aura",
          target: { filter: { isSelfRef: true }, count: 1, isSelf: true },
