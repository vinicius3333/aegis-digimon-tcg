...
const compiled: CompiledCard = {
  effects: [
    { trigger: "StartOfYourTurn", actions: [{ kind: "SetMemory", value: 3, condition: { kind: "memoryAtMost", controller: "mine", value: 2, raw: "you have 2 memory or less" } }] },
    {
      trigger: "AllTurns",
      actions: [{
        kind: "SubTrigger",
        ...
        actions: [{
          ...
          payCost: false,
          optional: true,
          dpCeilingModifier: { mode: "lowerCeiling", amount: 2000, scaling: { per: 1, unit: "security", filter: { controller: "opponent" } } },
