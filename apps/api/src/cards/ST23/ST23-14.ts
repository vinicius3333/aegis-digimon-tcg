    ...
    if (timing === EffectTiming.OnStartMainPhase) {
      return [
        turnTiming({
          ...
          description:
            "[Start of Your Main Phase] You may place the top card of your deck under this Tamer. " +
    ...
    if (timing === EffectTiming.OnEnterFieldAnyone) {
      return [
        onPlay({
          ...
          description:
            "[On Play] You may place the top card of your deck under this Tamer. Then, if your " +
            "opponent has a Digimon, gain 1 memory.",
    ...
    if (timing === EffectTiming.None) {
      return [
        staticModifier({
          ...
          description:
            "[Your Turn] When effects trash any of this Tamer's digivolution cards, by suspending " +
            "this Tamer, 1 of your [Glowing Dawn] trait Digimon gains ＜Jamming＞ for the turn.",
          ...
          resolve: async (ctx) => {
            ...
            ctx.fx.subscribeSubTrigger({
              ...
              once: false,
              description: `${cardId}: When digivolution trashed, suspend to give Jamming.`,
              matches: (subCtx) => {
              ...
              run: async (subCtx) => {
                ...
                const willDo = await subCtx.ask.optional(subCtx, "Suspend this Tamer to give Jamming?");
                if (!willDo) return;
