  ...
  effects: [
    {
      ...
      actions: [
        {
          effectTextPart:
            "[Main] 1 of your blue Digimon may digivolve into a blue Digimon card in the hand with the digivolution cost reduced by 3.",
          kind: "Digivolve",
          target: {
            filter: {
              controller: "mine",
    ...
    },
    {
      ...
      actions: [
        ...
        {
          effectTextPart:
            "Then, if you don't have a Digimon, you may play 1 blue Digimon card with 2000 DP or less from your trash without paying the cost.",
    ...
    },
    {
      ...
      actions: [
        {
          effectTextPart:
            "[Security] You may play 1 blue Digimon card with 2000 DP or less from your trash without paying the cost.",
          kind: "PlayWithoutCost",
          target: {
            filter: {
              controller: "mine",
