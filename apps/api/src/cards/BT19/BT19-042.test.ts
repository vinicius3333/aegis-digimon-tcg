...
describe("BT19-042 Dynasmon (X Antibody)", () => {
  ...
  it.each([[EffectTiming.WhenDigivolving, "BT19-041"], [EffectTiming.OnUseAttack, "BT19-039"]] as const)(
  ...
  it("shares one once-per-turn use between evolution and attack timings", async () => {
    const s = setupEngine({
      0: { battleArea: [{ card: "BT19-042", as: "dynasX", under: ["BT19-041"] }], security: ["BT19-030", "BT19-032"] },
