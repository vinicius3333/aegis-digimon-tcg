...
const compiled: CompiledCard = {
  effects: [
    ...
    { trigger: "OnDeletion", actions: [{ kind: "PlaceInBattleAreaSelf", target: { filter: { controller: "mine", zone: "trash", kind: ["Option"], nameOrTrait: [{ tokens: ["Device"], match: "trait" }], playCostLte: 3 }, count: 1, from: ["trash"] } }] },
