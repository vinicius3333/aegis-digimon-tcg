...
// CAPABILITY NOTE: The <Delay> cost requires trashing from a specific source Digimon's
// bottom-2 face-down digivolution stack. The 'trash' cost kind does not have 'fromDigivolutionOf',
// 'position', 'faceDown', or 'maxPosition' fields. Spec'd in LANE_D.md as CAP-LANE-D-01.
