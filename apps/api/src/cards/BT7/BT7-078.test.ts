...
describe("BT7-078 AncientSphinxmon", () => {
  it("deletes your Hybrid to delete an opposing Digimon of no greater level", async () => {
    ...
    const s = setupEngine({ 0: { battleArea: [{ card: "BT10-012", as: "base" }, { card: "BT7-073", as: "cost" }], hand: [{ card: "BT7-078", as: "evolving" }] }, 1: { battleArea: [{ card: "BT2-047", as: "target" }] } }, { autoAcceptOptional: true, autoSelectCards: true, preferInstanceIds: preferred });
