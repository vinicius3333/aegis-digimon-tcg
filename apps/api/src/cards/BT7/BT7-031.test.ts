...
describe("BT7-031 Herissmon", () => {
  it("returns itself to hand after being trashed for its host's Digi-Burst", async () => {
    ...
    const s = setupEngine({ 0: { battleArea: [{ card: "BT4-026", under: [{ card: "BT7-031", as: "herissmon" }, "BT1-001"], as: "host" }], deck: ["BT1-010"] } }, { autoSelectCards: true, preferInstanceIds: preferred });
