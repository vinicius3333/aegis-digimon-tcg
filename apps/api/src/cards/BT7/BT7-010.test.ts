...
describe("BT7-010 Tuskmon", () => {
  it("gives one of your Digimon +2000 DP for the turn", async () => {
    ...
    const s = setupEngine({ 0: { battleArea: [{ card: "BT1-009", as: "base" }, { card: "BT1-010", as: "target" }], hand: [{ card: "BT7-010", as: "evolving" }] } }, { autoSelectCards: true, preferInstanceIds: preferred });
