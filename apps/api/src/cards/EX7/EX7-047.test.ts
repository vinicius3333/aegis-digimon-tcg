...
describe("EX7-047", () => {
  ...
  it("requires a level 5 NSp Digimon for the alternate evolution", () => expect(compiled.digivolutionRequirement).toContainEqual(expect.objectContaining({ level: 5, traits: ["NSp"], cost: 3, isAlternate: true })));
});
