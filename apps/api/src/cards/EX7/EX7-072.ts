  ...
  effects: [
    {
      ...
      actions: [{
        ...
        sourceFilter: { controllerDefault: "mine", nameOrTrait: [{ tokens: ["Lilithmon (X Antibody)"], match: "name" }] },
        actions: [{
          kind: "ActivateMain",
          optional: true,
          abortOnDecline: true,
    ...
    },
    {
      trigger: "Security",
      isSecurity: true,
      actions: [{ kind: "Delete", target: { filter: { controller: "opponent", kind: ["Digimon"], unsuspended: true }, count: 1 } }],
    },
  ],
  coverage: "full",
  residual: [],
