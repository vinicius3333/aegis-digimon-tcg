...
describe("EX7-038", () => {
  ...
  it("requires a level 2 NSp Digimon for the alternate evolution", () => expect(compiled.digivolutionRequirement).toContainEqual(expect.objectContaining({ level: 2, traits: ["NSp"], cost: 0, isAlternate: true })));
});
