...
const compiled: CompiledCard = {
  effects: [
    ...
    {
      trigger: "OnPlay",
      actions: [{ kind: "Suspend", target: { filter: { controllerDefault: "any", excludeSelf: true, kind: ["Digimon", "Tamer"] }, count: "all" } }],
    },
    {
    ...
    {
      trigger: "WhenDigivolving",
      actions: [{ kind: "Delete", target: { filter: { controller: "opponent", suspended: true, kind: ["Digimon"] }, count: 1 } }],
