      ...
      actions: [
        {
          ...
          cost: { kind: "trash", target: { filter: { zone: "linked" }, count: 1 } },
        },
      ],
    });
      ...
      actions: [
        {
          ...
          actions: [{ kind: "ModifyDP", amount: -8000, duration: "forTheTurn" }],
        },
      ],
    });
      ...
      actions: [
        {
          ...
          actions: [
            {
              kind: "Prevent",
              cost: { kind: "trash", target: { filter: { isSelfRef: true, zone: "linked" }, count: 1 } },
            },
          ],
        },
      ],
