...
describe("BT8-017 UltimateBrachiomon", () => {
  it("matches its official dual-color effectless metadata and plays normally", async () => {
    expect(getCardDefinition("BT8-017")).toMatchObject({ nameEn: "UltimateBrachiomon", colors: ["Red", "Black"], level: 6, playCost: 10, dp: 13000, forms: ["Mega"], attributes: ["Data"], types: ["Cyborg", "X Antibody"] });
