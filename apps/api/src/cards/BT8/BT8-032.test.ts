...
describe("BT8-032 Imperialdramon: Fighter Mode", () => {
  it("returns an opposing 10000-DP-or-less Digimon to hand", async () => {
    const s = setupEngine({ 0: { battleArea: [{ card: "AD1-011", as: "base" }], hand: [{ card: "BT8-032", as: "evolving" }] }, 1: { battleArea: [{ card: "BT2-047", as: "target" }] } }, { autoSelectCards: true, autoOrderTriggers: true });
