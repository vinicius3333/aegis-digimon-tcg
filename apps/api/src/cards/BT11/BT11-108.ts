...
const compiled: CompiledCard = { effects: [
  ...
  { trigger: "Main", actions: [{ kind: "DeDigivolve", target: { filter: { controller: "opponent", kind: ["Digimon"] }, count: 3 }, amount: 1 }, { kind: "Trash", target: { filter: { controller: "opponent", kind: ["Digimon"], levels: [3] }, count: 1 } }, { kind: "Delete", target: { filter: { controller: "opponent", kind: ["Digimon"] }, count: 3 } }] },
