...
const compiled: CompiledCard = {
  effects: [
    { trigger: "OnDeletion", actions: [{ kind: "RevealAdd", revealCount: 3, add: [{ filter: { controllerDefault: "mine", nameOrTrait: [{ tokens: ["Chuumon", "Sukamon"], match: "name" }, { tokens: ["Etemon"], match: "name" }] }, count: 1, to: "hand" }], rest: "trash" }] },
