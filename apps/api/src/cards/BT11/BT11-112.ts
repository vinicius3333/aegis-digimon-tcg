...
const compiled: CompiledCard = { effects: [
  ...
  { trigger: "Static", actions: [{ kind: "SubTrigger", event: "whenSuspended", sourceFilter: { controller: "mine", kind: ["Digimon"], nameOrTrait: [{ tokens: ["Veedramon"], match: "name" }] }, actions: [{ kind: "ActivateEffect", target: { filter: { controller: "mine", kind: ["Digimon"], nameOrTrait: [{ tokens: ["Veedramon"], match: "name" }] }, count: 1 }, effectType: "WhenDigivolving", count: 1 }] }] },
