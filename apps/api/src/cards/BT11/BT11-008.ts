...
const module: EffectModule = {
  ...
  effectsForTiming(timing, source) {
    ...
    return [staticModifier({
      source,
      effectKey: `${cardId}/inherited-target-switch-dp`,
      ...
      resolve: async (ctx) => {
        ...
        ctx.fx.subscribeSubTrigger({
          ...
          once: false,
          oncePerTurnKey: `${source.instanceId}/${cardId}/target-switch-dp`,
          description: `${cardId}: this Digimon's attack target switched`,
