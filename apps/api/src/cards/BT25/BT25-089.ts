  ...
  effects: [
    ...
    },
    {
      ...
      actions: [{
        ...
        target: { filter: { controller: "mine", kind: ["Digimon"], nameOrTrait: [{ tokens: ["Appmon"], match: "trait" }], hasLinkRequirement: true }, count: 1 },
    ...
    },
    {
      ...
      actions: [{ kind: "AppFuse", source: { filter: { controller: "mine", kind: ["Digimon"] }, count: 1 }, into: { kind: ["Digimon"] }, from: ["hand"], raw: "1 of your Digimon may app fuse into a Digimon card in the hand." }],
    },
    {
      trigger: "Security",
      isSecurity: true,
