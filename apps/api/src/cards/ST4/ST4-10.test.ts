...
describe("ST4-10 Lillymon", () => {
  it("reveals 5 and adds a level 6 Digimon when digivolving", async () => {
    const s = setupEngine({ 0: { battleArea: [{ card: "ST4-08", as: "base" }], hand: [{ card: "ST4-10", as: "evolving" }], deck: ["ST4-03", { card: "ST4-12", as: "found" }, "ST4-03", "ST4-04", "ST4-06", "ST4-08"] } }, { autoSelectCards: true });
    s.state.memory = 4;
