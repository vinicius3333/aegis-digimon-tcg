...
const compiled: CompiledCard = {
  effects: [
    { trigger: "StartOfYourMainPhase", actions: [{ kind: "GainMemory", amount: 1, condition: { kind: "youHave", filter: { controllerDefault: "mine", kind: ["Digimon"], nameOrTrait: [{ tokens: ["Royal Base", "CS"], match: "trait" }] }, raw: "you have a Digimon with the [Royal Base] or [CS] trait" } }] },
    {
      trigger: "AllTurns",
      actions: [{
        kind: "SubTrigger",
