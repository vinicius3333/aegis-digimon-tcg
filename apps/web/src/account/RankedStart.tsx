...
export function RankedStart({
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <span>
            ...
            <span style={{ display: "block", fontSize: 11.5, color: "var(--ds-foreground-muted)", marginTop: 2 }}>
              {t("ranked.checkboxDescription")}
            </span>
          </span>
        </label>
        {authenticated === false ? (
      ...
      {error ? (
        <div role="alert" style={{ marginTop: 8, fontSize: 12, color: "var(--ds-danger, #b42318)" }}>
      ...
      {confirming ? (
        ...
        >
          ...
          >
            <strong id="ranked-title" style={{ fontSize: 19, color: "var(--ds-foreground)" }}>
              {t("ranked.confirmTitle")}
            </strong>
            <p style={{ fontSize: 13, lineHeight: 1.5, color: "var(--ds-foreground-muted)" }}>
              {t("ranked.confirmBody")}
            </p>
            <label
              style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: "var(--ds-foreground)" }}
            >
              <input
                type="checkbox"
