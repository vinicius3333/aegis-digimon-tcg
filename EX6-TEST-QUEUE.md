...
3. Stack/leave/replacement mechanics: `EX6-015.test.ts` (permanent relocation to its explicit self host before mandatory scaled return), `EX6-058.test.ts`, `EX6-060.test.ts`, `EX6-061.test.ts`, `EX6-065.test.ts`, `EX6-069.test.ts`.
4. Trigger and delayed-action mechanics: `EX6-062.test.ts`, `EX6-063.test.ts`, `EX6-064.test.ts`, `EX6-070.test.ts` (passed 1 file, 2/2, 7.53s in the authorized forks/singleFork/no-file-parallelism window; prevented Delay source trash with a visible legal Delete target), `EX6-074.test.ts`.
