...
4. Trigger and delayed-action mechanics: `EX6-062.test.ts`, `EX6-063.test.ts`, `EX6-064.test.ts`, `EX6-070.test.ts` (including prevented Delay source trash), `EX6-074.test.ts`.
5. Ogudomon per-activation/count boundaries: `EX6-073.test.ts` — exact Q3827 security count; duplicate names; unrelated stack; zero/prevented delete; and a second activation after a blocked/zero placement.
