...
This report, the BT9-030 direct correction, and the BT9-030 focused-test strengthening are intended for one atomic worker commit and a non-force push. The final stable commit hash and push result are supplied in the coordinator's worker completion message.
