...
- Snapshot: the committed generated data still carries the prior unsupported `"YourTurn"` duration marker; this is snapshot drift relative to the corrected direct module and should be regenerated by the coordinator.
