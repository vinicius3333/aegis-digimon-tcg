...
- Remaining range queue: BT7-011 through BT7-112 remains for the coordinator/other audit workers. This report covers only BT7-001 through BT7-010 and does not claim collection completion.
...
subrange; execution gates remain coordinator-owned and deferred.
