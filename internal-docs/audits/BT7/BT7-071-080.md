...
corrections: 1 (BT7-079 mandatory `Then` deletion). Documentation cleanup: 1 (BT7-078 comment
corrected to the catalog's level 6). Ambiguities recorded: 0. No direct module was left with a
