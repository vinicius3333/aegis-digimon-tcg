...
modules are fully traced and exclusively authoritative at runtime. The only
intentional registration boundary is BT3-067's no-module shape for a vanilla
card, documented by its empty snapshot and focused no-effect proof. Older
