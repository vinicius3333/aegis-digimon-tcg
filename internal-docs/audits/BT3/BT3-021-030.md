...
- `apps/api/src/engine/effects/interpreter/registration/module.ts:323-341`
  ...
  the required shape. Vanilla BT3-022 and BT3-028 intentionally have no direct
  module or set-index import.
...
- Status: the vanilla no-module boundary and legal evolution path are proven;
  no printed clause or residual ambiguity remains.
...
- Preserved the established vanilla-card boundary for BT3-022 and BT3-028:
