...
| EX5-043 | Leopardmon (X Antibody) | 2 | Generated watcher is normalized: its resolved paid green play folds the fixed −4 and live Leopardmon/X Antibody stack −3 into pay time, while Return uses base 5000 plus executable +3000 per other friendly Digimon through the shared removal ceiling consumer. | Pending focused proof |
