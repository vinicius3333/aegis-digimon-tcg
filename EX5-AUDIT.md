...
| EX5-016 | Lunamon | 5 | Start Main gains two memory only after returning one own Digimon; inherited Main once-per-turn gains two only by rotating a qualifying Night Claw/Light Fang top card to that host’s own stack bottom. | Pending focused proof |
