...
| EX5-058 | Octomon | 6 | Entry modal branches on live total Digimon/token count: ≥4 self-side token play or ≤3 opponent-side suspended token; inherited opponent effect-play watcher uses shared entry payload and Once Per Turn. | Pending focused proof |
