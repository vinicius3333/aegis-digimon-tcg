...
| EX5-037 | Vajramon | 11 | On Play draw then optional distinct-name Deva breeding play; owner-turn Option-cost≥1 watcher gains memory, while inherited Piercing aura continuously follows Four Sovereigns/God Beast host trait. | Pending focused proof |
...
| EX5-070 | X Antibody Proto Form | 5 | Catalog Q3679-Q3682/Q4260 → hand-authored Main stack-name exclusion plus inherited replacement; live filter/candidate fixtures prove Proto Form self-exclusion and host-stack-only return, and the pending focused run must additionally execute the shared replacement order/security placement seam. | Pending focused run |
