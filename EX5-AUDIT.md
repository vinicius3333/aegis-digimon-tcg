...
| EX5-016 | Lunamon | 5 | Start Main gains two memory only after returning one own Digimon; inherited Main once-per-turn payment now validates the live Night Claw/Light Fang host before rotating its top card to its own stack bottom. | Pending focused proof |
| EX5-017 | Lekismon | 2 | Both entry routes independently reveal three for Night Claw and Light Fang/Galaxy slots then bottom remaining cards; inherited opponent-turn +2000 DP is self-only. | Pending focused proof |
| EX5-018 | Garurumon (X Antibody) | 1 | Evolution draw-two/trash-two then source-gated memory uses live Garurumon/X Antibody stack match; inherited battle-only deletion replacement returns two non-Egg trash cards and must prevent once paid (Q3562), Once Per Turn. | Pending focused proof |
| EX5-019 | Antylamon | 6 | On Play draw then optional distinct-name Deva breeding play; attack trashes one opponent source (not top), while inherited once-per-turn memory uses the live Four Sovereigns/God Beast host trait. | Pending focused proof |
...
| EX5-038 | Vikaralamon | 6 | On Play draw then optional distinct-name Deva breeding play; Your Turn friendly entry watcher unsuspends self, and inherited Piercing aura continuously follows Four Sovereigns/God Beast host trait. | Pending focused proof |
...
| EX5-040 | Kumbhiramon | 6 | On Play draw then optional distinct-name Deva breeding play; All Turns opponent Digimon deletion watcher draws, and inherited Piercing aura has the printed friendly trait presence gate. | Pending focused proof |
...
| EX5-043 | Leopardmon (X Antibody) | 2 | Generated watcher is normalized: paid green play now uses fixed −4 plus a reusable live stack-gated Leopardmon/X Antibody −3 reducer, while Return uses base 5000 plus executable +3000 per other friendly Digimon through the shared removal ceiling consumer. | Pending focused proof |
...
| EX5-054 | MetalEtemon | 2 | Entry deletion targets opponent Digimon/Tamer at cost≤3 plus live own-trash Etemon/Sukamon scaling; opponent attack watcher optionally redirects to self or player (Q3647) only after placing a matching hand card atop own security, Once Per Turn. | Pending focused proof |
...
| EX5-065 | Sayo & Koh | 2 | Add-source watcher now requires placing the owner’s top card at a stack bottom (Q3669), not ordinary digivolution; the focused file now uses a real BT1-069→BT1-080 ordinary digivolve negative fixture alongside the positive placement event. | Pending focused run |
| EX5-066 | Phoebus Blow | 1 | Main deletes shared lowest-DP opponent selector, then returns exact Light Fang/Night Claw trash Digimon only while a friendly Tamer remains live; Security directly activates Main. | Pending focused proof |
| EX5-067 | Good Night Moon | 2 | Main restricts one opponent Digimon and one Tamer from suspending through opponent-turn end, then optionally free-plays a named-trait Tamer; Security activates the same Main sequence. | Pending focused proof |
| EX5-068 | Flashy Boss Punch | 0 | Live Leomon/Bancho presence waives color; Main suspends then gives an opponent −12000 DP for the turn and may attack with matching ally, while Security preserves only suspend/DP branches. | Pending focused proof |
...
| 2 | Deva breeding play, name exclusion, and inherited trait auras | EX5-009, EX5-010, EX5-011, EX5-019, EX5-021, EX5-022, EX5-037 (trait positives/negative and live lapse), EX5-038, EX5-040, EX5-050, EX5-051, EX5-052 |
| 3 | Stack placement/rotation, cost and replacement semantics | EX5-001, EX5-002, EX5-007, EX5-012, EX5-013, EX5-014, EX5-016, EX5-018, EX5-020, EX5-023, EX5-026 (broad entry / non-play, filter, dedupe, expiry), EX5-029, EX5-030, EX5-031, EX5-034, EX5-043, EX5-046, EX5-054, EX5-055, EX5-057, EX5-059, EX5-060, EX5-061, EX5-064, EX5-069, EX5-072, EX5-074 |
