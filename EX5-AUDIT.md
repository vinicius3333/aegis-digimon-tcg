...
| EX5-059 | Dobermon (X Antibody) | 2 | On Play grants Retaliation through opponent-turn end; evolution draw/trash may reactivate that route only from a live Dobermon/X Antibody stack, and inherited effect-play watcher gains memory Once Per Turn. | Pending focused proof |
